...
for (let i = 0; i < names.length; i++) {
    ...
    let guestList3 = ["hashir", "asad", "anus", "ali", "maaz"];
    ...
    let guestList4 = ["hashir", "asad", "anus",];
    ...
    let guestList5 = ['hashir', 'anus', 'tabish'];
    ...
    let countries = ["mount everst", "sutlej", "pakistan", "karachi", "urdu"];
   ...
   // Store the numbers 1 through 9 in an array*/
    ...
    let magicians6 = ["haris", "david", "usman",];
